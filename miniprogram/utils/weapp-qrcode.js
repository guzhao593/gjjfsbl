...
(function () {
  ...
  function _fillRectWithMask(canvas, x, y, w, h, maskSrc, bDark) {
    ...
    if (maskSrc === undefined) {
      ...
      canvas.setFillStyle(bDark ? "rgba(0, 0, 0, .8)" : "rgba(255, 255, 255, .8)");
      canvas.fillRect(x, y, w, h);
    ...
    function step1(maskSrc) {
      ...
      for (var row = 0; row < nCount; row++) {
        for (var col = 0; col < nCount; col++) {
          ...
          _oContext.setFillStyle(bIsDark ? _htOption.colorDark : "rgba(255, 255, 255, 0.8)"); //_htOption.colorLight;
      ...
      var protectorStyle = "rgba(255, 255, 255, 0.8)";
      ...
      for (var i = 0; i < agnPatternCenter.length; i++) {
        for (var j = 0; j < agnPatternCenter.length; j++) {
          ...
          if (agnX === 6 && (agnY === 6 || agnY === edgeCenter)) {
            ...
            _oContext.setFillStyle("rgba(0, 0, 0, .8)");
